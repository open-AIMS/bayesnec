...
```{r brms-plot, fig.height=7, fig.cap="Default brms plot of the nec4param model showing the posterior probability densities and chain mixing for each of the included parameters.", dependson="fit"}
...
```{r base-plot, fig.height=5, fig.cap="Base plot of the example fit model averaged curve. The solid black line is the fitted median of the posterior prediction, dashed black lines are the 95 percent credible intervals, and the red vertical lines show the estimated NEC value.", dependson="fit"}
plot(exmp_fit)
```
...
```{r sample-prior, fig.cap="Frequency histograms of samples of the default priors used by bnec for fitting the nec4param model to the example data.", dependson="fit"}
...
```{r check-priorsingle, fig.cap="A comparison of the prior and posterior parameter probability densities for the nec4param model fit to the example data.", dependson="fit"}
