...
![Default pkg{brms} plot of the `nec4param` model showing the posterior probability densities and chain mixing for each of the included parameters.\label{fig:brmsplot}](brms_plot.png)
