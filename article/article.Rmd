...
knitr::kable(modtab, caption="Fitted models and their relative pseudo-BMA weights for C-R curves for the effects seven herbicides on maximum effective quantum yield of symbiotic dinoflagellates of the coral Seriatopora hystrix.")
```
