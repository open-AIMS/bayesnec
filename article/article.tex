...
By default the plot shows the fitted posterior curve with 95\% credible intervals, along with an estimate of the \(\eta = \text{NEC}\) value. For more examples using \pkg{bayesnec} models for inference please see the on-line the vignettes at \url{https://open-aims.github.io/bayesnec/articles/}, as well as Section \ref{modsuit} below.
