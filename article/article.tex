...
\caption[Default brms plot of the nec4param model showing the posterior probability densities and chain mixing for each of the included parameters]{Default brms plot of the nec4param model showing the posterior probability densities and chain mixing for each of the included parameters.}\label{fig:brms-plot}
\end{figure}
\end{CodeChunk}
...
\caption[Base plot of the example fit model averaged curve]{Base plot of the example fit model averaged curve. The solid black line is the fitted median of the posterior prediction, dashed black lines are the 95 percent credible intervals, and the red vertical lines show the estimated NEC value.}\label{fig:base-plot}
\end{figure}
\end{CodeChunk}
...
\caption[Frequency histograms of samples of the default priors used by bnec for fitting the nec4param model to the example data]{Frequency histograms of samples of the default priors used by bnec for fitting the nec4param model to the example data.}\label{fig:sample-prior}
\end{figure}
\end{CodeChunk}
...
\caption[A comparison of the prior and posterior parameter probability densities for the nec4param model fit to the example data]{A comparison of the prior and posterior parameter probability densities for the nec4param model fit to the example data.}\label{fig:check-priorsingle}
\end{figure}
\end{CodeChunk}
