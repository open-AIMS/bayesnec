...
#include "stanExports_necsigmpoisson.h"

RCPP_MODULE(stan_fit4necsigmpoisson_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_necsigmpoisson")
