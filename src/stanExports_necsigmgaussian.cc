...
#include "stanExports_necsigmgaussian.h"

RCPP_MODULE(stan_fit4necsigmgaussian_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_necsigmgaussian")
