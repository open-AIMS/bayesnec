...
#include "stanExports_ecxwb1gaussian.h"

RCPP_MODULE(stan_fit4ecxwb1gaussian_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_ecxwb1gaussian")
