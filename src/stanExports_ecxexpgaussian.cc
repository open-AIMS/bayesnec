...
#include "stanExports_ecxexpgaussian.h"

RCPP_MODULE(stan_fit4ecxexpgaussian_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_ecxexpgaussian")
