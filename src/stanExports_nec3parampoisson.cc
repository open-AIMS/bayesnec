...
#include "stanExports_nec3parampoisson.h"

RCPP_MODULE(stan_fit4nec3parampoisson_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_nec3parampoisson")
