...
#include "stanExports_ecx4paramnegbin.h"

RCPP_MODULE(stan_fit4ecx4paramnegbin_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_ecx4paramnegbin")
