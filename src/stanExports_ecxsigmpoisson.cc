...
#include "stanExports_ecxsigmpoisson.h"

RCPP_MODULE(stan_fit4ecxsigmpoisson_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_ecxsigmpoisson")
