...
#include "stanExports_ecxsigmgaussian.h"

RCPP_MODULE(stan_fit4ecxsigmgaussian_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_ecxsigmgaussian")
