...
#include "stanExports_nec3parambinom.h"

RCPP_MODULE(stan_fit4nec3parambinom_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_nec3parambinom")
