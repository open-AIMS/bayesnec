...
#include "stanExports_ecxlingaussian.h"

RCPP_MODULE(stan_fit4ecxlingaussian_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_ecxlingaussian")
