...
#include "stanExports_nechormepoisson.h"

RCPP_MODULE(stan_fit4nechormepoisson_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_nechormepoisson")
