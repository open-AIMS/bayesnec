...
#include "stanExports_ecx4parampoisson.h"

RCPP_MODULE(stan_fit4ecx4parampoisson_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_ecx4parampoisson")
