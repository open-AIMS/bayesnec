...
#include "stanExports_nec4paramgaussian.h"

RCPP_MODULE(stan_fit4nec4paramgaussian_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_nec4paramgaussian")
