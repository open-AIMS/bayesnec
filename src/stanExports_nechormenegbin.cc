...
#include "stanExports_nechormenegbin.h"

RCPP_MODULE(stan_fit4nechormenegbin_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_nechormenegbin")
