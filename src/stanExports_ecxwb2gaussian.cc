...
#include "stanExports_ecxwb2gaussian.h"

RCPP_MODULE(stan_fit4ecxwb2gaussian_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_ecxwb2gaussian")
