...
#include "stanExports_nechormegaussian.h"

RCPP_MODULE(stan_fit4nechormegaussian_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_nechormegaussian")
