...
#include "stanExports_nec4paramnegbin.h"

RCPP_MODULE(stan_fit4nec4paramnegbin_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_nec4paramnegbin")
