...
#include "stanExports_nec4parambinom.h"

RCPP_MODULE(stan_fit4nec4parambinom_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_nec4parambinom")
