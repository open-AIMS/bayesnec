...
```r
autoplot(exp_5)
#> Error in if (family$family == "binomial" | family == "beta_binomial") {: the condition has length > 1
```
...
#> nec4param nec4param -84.27926 3.014199e-01                  NA              NA
#> neclin       neclin -52.79191 2.623904e-03                  NA              NA
#> ecxlin       ecxlin -27.94184 3.761823e-07                  NA              NA
#> ecx4param ecx4param -81.52933 8.838216e-02                  NA              NA
#> ecxwb1       ecxwb1 -75.57556 1.735654e-02                  NA              NA
#> ecxwb2       ecxwb2 -85.20960 3.016702e-01                  NA              NA
#> ecxll5       ecxll5 -84.05179 1.798918e-01                  NA              NA
#> ecxll4       ecxll4 -81.94990 1.086551e-01                  NA              NA
#>           dispersion_Q97.5
#> nec4param               NA
#> neclin                  NA
#> ecxlin                  NA
...
#>             waic   wi
#> nec4param -84.28 0.30
#> neclin    -52.79 0.00
#> ecxlin    -27.94 0.00
#> ecx4param -81.53 0.09
#> ecxwb1    -75.58 0.02
#> ecxwb2    -85.21 0.30
#> ecxll5    -84.05 0.18
#> ecxll4    -81.95 0.11
...
#> Error in `map()`:
#> ℹ In index: 1.
#> ℹ With name: nec4param.
#> Caused by error in `if (family$family == "binomial" | family == "beta_binomial") ...`:
...
rhat(exp_5) |>
  sapply("[[", "failed")
#> Error in UseMethod("rhat"): no applicable method for 'rhat' applied to an object of class "c('bayesmanecfit', 'bnecfit')"
```
