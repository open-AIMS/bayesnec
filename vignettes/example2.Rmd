...
``` r
exp_5$mod_stats
#>               model      waic           wi dispersion_Estimate dispersion_Q2.5
#> nec4param nec4param -84.50915 4.170333e-01                  NA              NA
#> neclin       neclin -52.69978 8.016379e-04                  NA              NA
#> ecxlin       ecxlin -27.39045 3.005558e-07                  NA              NA
#> ecx4param ecx4param -82.02895 1.388141e-01                  NA              NA
#> ecxwb1       ecxwb1 -74.97724 1.502345e-02                  NA              NA
#> ecxwb2       ecxwb2 -84.81931 3.294592e-01                  NA              NA
#> ecxll4       ecxll4 -81.32959 9.886802e-02                  NA              NA
#>           dispersion_Q97.5
#> nec4param               NA
#> neclin                  NA
#> ecxlin                  NA
...
#>             waic   wi
#> nec4param -84.51 0.42
#> neclin    -52.70 0.00
#> ecxlin    -27.39 0.00
#> ecx4param -82.03 0.14
#> ecxwb1    -74.98 0.02
#> ecxwb2    -84.82 0.33
#> ecxll4    -81.33 0.10
#> 
...
rhat(exp_5) |>
  sapply("[[", "failed")
#> nec4param    neclin    ecxlin ecx4param    ecxwb1    ecxwb2    ecxll4 
...
not converge, and should be dropped with `amend(drop = )` before the set is
averaged --- note that we have also used far fewer than the default `bayesnec`
`iter` (10,000) here, which makes convergence harder than it would usually be.
...
`rhat()` reports Rhat alone. To screen on all three sampler diagnostics at once
--- Rhat, effective sample size and divergent transitions --- use
`check_sampling()`, and `screen_models()` to drop the failures and report what
went:
...
#> 1 nec4param 1.012503 493.2325     0.3082703           0   TRUE
#> 2    neclin 1.009107 620.9875     0.3881172           0  FALSE
#> 3    ecxlin 1.006625 477.9621     0.2987263           0  FALSE
#> 4 ecx4param 1.006233 773.4783     0.4834240           0  FALSE
#> 5    ecxwb1 1.005988 478.9532     0.2993457           0  FALSE
#> 6    ecxwb2 1.011400 603.2124     0.3770077           0   TRUE
#> 7    ecxll4 1.006276 674.9986     0.4218741           0  FALSE
```
