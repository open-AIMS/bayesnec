...
#> nec4param       nec4param -333.2649 3.101033e-01                  NA              NA               NA
#> nechorme4       nechorme4 -332.2417 1.518190e-01                  NA              NA               NA
#> neclin             neclin -332.8021 2.544037e-01                  NA              NA               NA
#> neclinhorme   neclinhorme -331.9170 1.679910e-01                  NA              NA               NA
#> nechorme4pwr nechorme4pwr -331.5084 1.126893e-01                  NA              NA               NA
#> ecxlin             ecxlin -188.2603 2.340610e-26                  NA              NA               NA
#> ecx4param       ecx4param -301.3961 8.299225e-07                  NA              NA               NA
#> ecxwb1             ecxwb1 -294.2887 5.256828e-08                  NA              NA               NA
#> ecxwb2             ecxwb2 -317.0351 3.187765e-04                  NA              NA               NA
#> ecxll5             ecxll5 -320.4981 2.662438e-03                  NA              NA               NA
#> ecxll4             ecxll4 -301.6857 8.645829e-07                  NA              NA               NA
#> ecxhormebc5   ecxhormebc5 -309.4918 1.069173e-05                  NA              NA               NA
```
...
#>                 waic   wi
#> nec4param    -333.26 0.31
#> nechorme4    -332.24 0.15
#> neclin       -332.80 0.25
#> neclinhorme  -331.92 0.17
#> nechorme4pwr -331.51 0.11
#> ecxlin       -188.26 0.00
#> ecx4param    -301.40 0.00
#> ecxwb1       -294.29 0.00
#> ecxwb2       -317.04 0.00
#> ecxll5       -320.50 0.00
#> ecxll4       -301.69 0.00
#> ecxhormebc5  -309.49 0.00
#> 
#> 
...
#> 1.573776 1.516332 1.621647 
#> attr(,"precision")
#> [1] 1000
ECx50
#>    ec_50 ec_50_lw ec_50_up 
#> 1.995036 1.950357 2.042907 
#> attr(,"precision")
#> [1] 1000
```
