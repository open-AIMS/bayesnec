...
To run this vignette, we will also the `ggplot2` package:
...
exp_5 <- bnec(data = df_, x_var = "x", y_var = "y", model = "decline")
```
...
#> nec4param nec4param -40.92728 7.174573e-02           1.0037390       0.7472733         1.343210
#> neclin       neclin  18.93904 5.633419e-07           0.9927333       0.7381123         1.323705
#> ecxlin       ecxlin  26.71240 1.548137e-08           0.9950939       0.7289419         1.336223
#> ecx4param ecx4param -45.53921 1.870971e-01           0.9951894       0.7424944         1.337926
#> ecxwb1       ecxwb1 -45.81931 2.519042e-01           0.9959100       0.7445269         1.334085
#> ecxwb2       ecxwb2 -43.02705 8.399252e-02           0.9881679       0.7431564         1.335885
#> ecxll5       ecxll5 -45.70696 2.027252e-01           0.9923862       0.7321573         1.319936
#> ecxll4       ecxll4 -45.69926 2.025347e-01           0.9940246       0.7505689         1.329992
```
...
#> nec4param -40.93 0.07                1.00            0.75             1.34
#> neclin     18.94 0.00                0.99            0.74             1.32
#> ecxlin     26.71 0.00                1.00            0.73             1.34
#> ecx4param -45.54 0.19                1.00            0.74             1.34
#> ecxwb1    -45.82 0.25                1.00            0.74             1.33
#> ecxwb2    -43.03 0.08                0.99            0.74             1.34
#> ecxll5    -45.71 0.20                0.99            0.73             1.32
#> ecxll4    -45.70 0.20                0.99            0.75             1.33
#> 
#> 
...
<img src="vignette-fig-unnamed-chunk-10-1.png" title="plot of chunk unnamed-chunk-10" alt="plot of chunk unnamed-chunk-10" width="100%" />
...
<img src="vignette-fig-unnamed-chunk-11-1.png" title="plot of chunk unnamed-chunk-11" alt="plot of chunk unnamed-chunk-11" width="100%" />
...
#> 3.582401 2.858313 4.296569 
#> attr(,"precision")
#> [1] 1000
ECx50
#>    ec_50 ec_50_lw ec_50_up 
#> 4.852034 4.623897 5.080171 
#> attr(,"precision")
#> [1] 1000
```
