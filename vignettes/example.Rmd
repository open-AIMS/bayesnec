...
out.NEC <- amend(out, drop = "nec3param")
```
 and then drop the *necsigmoidal* model as invalid (see above)
 
 
```{r dropmod-beta-MANEC}
out.NEC <- amend(out.NEC, drop.models = "necsigmoidal")
out <- amend(out, drop.models = "necsigmoidal")
...
out.NEC <- amend(out.NEC, drop.models = "nechormesis")
out <- amend(out, drop.models = "nechormesis")
```
