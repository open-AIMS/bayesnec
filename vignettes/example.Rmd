...
<!-- ```{r fit-binomial-NEC2, cache=TRUE, echo=FALSE, fig.width = 7, fig.height = 20} -->
<!-- set.seed(333) -->
<!-- out <- bnec( -->
<!--   data = binom.data, -->
<!--   x_var = "raw.x", -->
...
<!-- ```{r fit-binomial-logx-NEC, cache=TRUE, echo=FALSE, fig.width = 7, fig.height = 20} -->
<!-- set.seed(333) -->
...
<!-- ```{r fit-binomial-4param-NEC, cache=TRUE, echo=FALSE, fig.width = 7, fig.height = 20} -->
<!-- set.seed(333) -->
<!-- out <- bnec( -->
<!--   data = binom.data, -->
<!--   x_var = "log.x", -->
...
<!-- ```{r fit-binomial-ECx, cache=TRUE, echo=FALSE, fig.width = 7, fig.height = 20} -->
<!-- set.seed(333) -->
<!-- out <- bnec( -->
<!--   data = binom.data, -->
<!--   x_var = "log.x", -->
...
<!-- ```{r fit-binomial-beta-ECx, cache=TRUE, echo=FALSE, fig.height = 20} -->
<!-- set.seed(333) -->
...
<!-- ```{r fit-binomial-beta-NEC, cache=TRUE, echo=FALSE, fig.width = 7, fig.height = 20} -->
<!-- set.seed(333) -->
<!-- out <- bnec( -->
<!--   data = binom.data, -->
<!--   x_var = "log.x", -->
...
<!-- ```{r plot_mod-beta-MANEC, fig.width = 7, fig.height = 20} -->
...
<!-- ```{r checkchains-beta-MANEC, fig.width = 7, fig.height = 20} -->
...
<!-- preds <- out.NEC$w_pred_vals$data -->
