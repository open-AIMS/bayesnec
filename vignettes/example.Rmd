...
set.seed(333)
exp_1 <- bnec(data = binom_data, x_var = "raw_x",
...
```{r, fig.width = 7, fig.height = 7}
set.seed(333)
exp_5 <- bnec(data = binom_data, x_var = "raw_x",
...
par(mfrow = c(1, 2))
plot(exp_5)
plot(binom_data$raw_x, exp_5$residuals, xlab = "concentration",
     ylab = "Residuals")
```
...
set.seed(333)
exp_6 <- bnec(data = binom_data, x_var = "log_x",
              y_var = "suc", trials_var = "tot",
              model = "nec3param")
...
par(mfrow = c(1, 2))
plot(exp_6)
plot(binom_data$log_x, exp_6$residuals, xlab = "concentration (log)",
     ylab = "Residuals")
```
...
```{r, fig.width = 7, fig.height = 7}
set.seed(333)
exp_7 <- bnec(data = binom_data, x_var = "log_x",
              y_var = "suc", trials_var = "tot",
              model = "nec4param")
...
par(mfrow = c(1, 2))
plot(exp_7)
plot(binom_data$log_x, exp_7$residuals, xlab = "concentration (log)",
     ylab = "Residuals")
```
...
```{r, fig.width = 7, fig.height = 7}
set.seed(333)
exp_8 <- bnec(data = binom_data, x_var = "log_x",
              y_var = "suc", trials_var = "tot",
              model = "ecx4param")
...
par(mfrow = c(1, 2))
plot(exp_8)
plot(binom_data$log_x, exp_8$residuals, xlab = "concentration (log)",
     ylab = "Residuals")
```
...
exp_9 <- bnec(data = binom_data, x_var = "log_x",
...
par(mfrow = c(1, 2))
plot(exp_9)
plot(binom_data$log_x, exp_9$residuals, xlab = "concentration (log)",
     ylab = "Residuals")
```
...
From the results we can see that we now have a much better fit in terms of dispersion, with an over-dispersion parameter of `r exp_9$dispersion`, and much wider more representative confidence bands. Let us see if the `beta` distribution would also have improved our original *NEC* model fit.


```{r, fig.width = 7, fig.height = 7}
set.seed(333)
exp_10 <- bnec(data = binom_data, x_var = "log_x",
...
par(mfrow = c(1, 2))
plot(exp_10)
plot(binom_data$log_x, exp_10$residuals, xlab = "concentration (log)",
     ylab = "Residuals")
```
...
```{r, results = "hide"}
set.seed(333)
exp_11 <- bnec(data = binom_data, x_var = "log_x",
               y_var = "prop", model = "all")
# save(exp_11, file = "exp_11.RData")
```
...
```{r, fig.width = 7, fig.height = 7}
exp_11_nec3param <- pull_out(exp_11, model = "nec3param")
plot(exp_11_nec3param)
```
...
```{r, fig.width = 7, fig.height = 7}
plot(exp_11$mod_fits$ecx4param$fit)
```

```{r, fig.width = 7, fig.height = 7}
plot(exp_11$mod_fits$ecxwb1$fit)
```
...
```{r}
ECx10 <- ecx(exp_11, ecx_val = 10)
ECx50 <- ecx(exp_11, ecx_val = 50)
...
```{r, fig.width = 7, fig.height = 7}
preds <- exp_11_nec$w_pred_vals$data

plot(exp_11, add_nec = FALSE)
