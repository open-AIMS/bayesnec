...
#>                 Q50 Q2.5 Q97.5
#> combined (NEC) 1.09 0.81  1.37
#> growth (NEC)   1.09 0.81  1.37
#> survival (NEC) 2.21 1.92  2.60
#> 
#> ECx estimates
#>                Q50 Q2.5 Q97.5
#> combined ec10 1.27 1.02  1.53
#> combined ec50 2.23 2.05  2.43
#> growth ec10   1.27 1.02  1.53
#> growth ec50   2.32 2.14  2.50
#> survival ec10 2.31 2.03  2.67
#> survival ec50 2.85 2.59  3.11
#> 
...
rbind(
  ...
  round(3)
#>                 Q50  Q2.5 Q97.5
#> growth NSEC   1.206 0.971 1.478
#> combined NSEC 1.225 0.985 1.502
#> growth EC10   1.275 1.021 1.534
#> combined EC10 1.275 1.021 1.534
#> growth EC50   2.321 2.141 2.500
#> combined EC50 2.226 2.052 2.425
```
...
#> top       24.78      0.73    23.41    26.27 1.00     7036     5321
#> beta      -0.58      0.09    -0.75    -0.41 1.00     5622     5411
#> nec        1.08      0.16     0.81     1.36 1.00     5264     5410
#> hutop      0.96      0.01     0.92     0.99 1.00     7610     4563
#> hubeta     0.12      0.21    -0.27     0.55 1.00     5964     5969
#> hunec      2.22      0.22     1.91     2.61 1.00     5820     6122
#> 
#> Further Distributional Parameters:
#>       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> shape    11.03      1.24     8.78    13.55 1.00     7543     5586
#> 
...
round(comparison, 3)
#>                             Q50  Q2.5 Q97.5
#> factorised, combined      1.088 0.809 1.369
#> joint, combined           1.081 0.809 1.361
#> factorised, growth EC10   1.275 1.021 1.534
#> joint, growth EC10        1.270 1.021 1.524
#> factorised, survival EC10 2.306 2.032 2.669
#> joint, survival EC10      2.316 2.027 2.679
```
...
#>                     Q50      Q2.5    Q97.5
#> survivors only 1.088469 0.8088084 1.369198
#> hurdle, growth 1.088469 0.8088084 1.369198
```
...
#> 1 0  24.75    0.964    23.82
#> 2 1  24.48    0.964    23.55
#> 3 2  14.83    0.961    14.20
#> 4 3   8.44    0.408     3.43
#> 5 4   4.79    0.131     0.63
#> 6 5   2.73    0.043     0.12
```
...
#>   nec3param     0.390     0.091     0.043      0  0.026  0.053
#>   nec4param     0.138     0.032     0.015      0  0.009  0.019
#>   ecx4param     0.023     0.005     0.003      0  0.002  0.003
#>   ecxexp        0.001     0.000     0.000      0  0.000  0.000
#>   ecxwb1        0.015     0.003     0.002      0  0.001  0.002
#>   ecxll3        0.081     0.019     0.009      0  0.005  0.011
```
...
#> No-effect toxicity estimates
#>                    Q50 Q2.5 Q97.5
#> combined (N(S)EC) 1.07 0.31  1.44
#> growth (N(S)EC)   1.07 0.31  1.44
#> survival (N(S)EC) 2.24 1.43  2.85
#> 
...
#> ECx estimates
#>                Q50 Q2.5 Q97.5
#> combined ec10 1.25 0.49  1.57
#> combined ec50 2.22 1.96  2.42
#> growth ec10   1.25 0.49  1.57
#> growth ec50   2.30 2.11  2.50
#> survival ec10 2.34 1.82  2.86
#> survival ec50 2.89 2.55  3.18
#> 
#> The combined endpoint is the expected response per individual exposed,
#> i.e. growth * survival. Use which = to select a component.
```
...
#> Regression Coefficients:
#>        Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> top       24.75      0.73    23.48    26.34 1.00     1851     1684
#> beta      -0.57      0.09    -0.74    -0.40 1.00     1616     1870
#> nec        1.09      0.16     0.81     1.35 1.00     1478     1827
#> hutop      0.96      0.02     0.93     0.98 1.00     2483     2050
#> hubeta     0.12      0.22    -0.26     0.56 1.00     1623     2073
#> hunec      2.22      0.22     1.92     2.61 1.00     1602     2313
#> 
#> Further Distributional Parameters:
#>       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> shape    11.03      1.22     8.81    13.66 1.00     2468     1851
#> 
#> Draws were sampled using sample(hmc). For each parameter, Bulk_ESS
#> and Tail_ESS are effective sample size measures, and Rhat is the potential
#> scale reduction factor on split chains (at convergence, Rhat = 1).
...
do.call(rbind, sens)
#>                              Q50       Q2.5      Q97.5
#> recorded deaths only  0.06626993 0.03749132 0.09727525
#> + first all-dead dose 0.08349523 0.05161052 0.09900356
#> + all all-dead doses  0.08533552 0.05681672 0.09838976
```
...
#> No-effect toxicity estimates
#>                    Q50 Q2.5 Q97.5
#> combined (N(S)EC) 0.60 0.20  1.14
#> growth (N(S)EC)   0.60 0.20  1.14
#> survival (N(S)EC) 1.70 1.17  2.39
#> 
#> NSEC values appear where a model set contains smooth (ECx) models, which
#> carry no threshold parameter; N(S)EC is a model-averaged combination
#> of the two (Fisher et al. 2023).
...
#> ECx estimates
#>                Q50 Q2.5 Q97.5
#> combined ec10 0.64 0.00  1.10
#> combined ec50 1.04 0.74  1.24
#> growth ec10   0.63 0.00  1.10
#> growth ec50   1.06 0.74  1.24
#> survival ec10 1.71 0.00  2.35
#> survival ec50 2.08 1.46  2.49
#> 
#> The combined endpoint is the expected response per individual exposed,
#> i.e. growth * survival. Use which = to select a component.
```
...
#>            survival
#> growth      nec3param nec4param ecx4param ecxexp ecxwb1 ecxll3
#>   nec3param     0.183     0.035     0.029      0  0.028  0.126
#>   nec4param     0.095     0.018     0.015      0  0.015  0.066
#>   ecx4param     0.054     0.010     0.009      0  0.008  0.037
#>   ecxexp        0.006     0.001     0.001      0  0.001  0.004
#>   ecxwb1        0.043     0.008     0.007      0  0.007  0.030
#>   ecxll3        0.074     0.014     0.012      0  0.011  0.051
```
...
#> No-effect toxicity estimates
#>                 Q50 Q2.5 Q97.5
#> combined (NEC) 1.69 1.41  1.92
#> growth (NEC)   1.69 1.42  1.92
#> survival (NEC) 3.18 2.09  4.13
#> 
#> ECx estimates
#>                Q50 Q2.5 Q97.5
#> combined ec10 2.00 1.75  2.20
#> combined ec50 3.50 3.12  3.82
#> growth ec10   2.00 1.76  2.20
#> growth ec50   3.69 3.45  3.99
#> survival ec10 3.66 2.73  4.55
#> survival ec50 6.34 5.30  7.97
#> 
#> The combined endpoint is the expected response per individual exposed,
#> i.e. growth * survival. Use which = to select a component.
```
...
#> Regression Coefficients:
#>        Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> top        0.68      0.01     0.66     0.71 1.00     7317     5754
#> beta      -1.06      0.09    -1.24    -0.90 1.00     5592     4437
#> nec        1.70      0.12     1.41     1.92 1.00     5065     4213
#> zitop      0.97      0.02     0.91     0.99 1.00     8093     4768
#> zibeta    -1.50      0.24    -2.00    -1.07 1.00     5776     4738
#> zinec      3.17      0.45     2.07     4.12 1.00     5261     2512
#> 
#> Further Distributional Parameters:
#>     Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> phi    28.45      4.14    21.06    37.39 1.00     7612     5946
#> 
#> Draws were sampled using sample(hmc). For each parameter, Bulk_ESS
#> and Tail_ESS are effective sample size measures, and Rhat is the potential
#> scale reduction factor on split chains (at convergence, Rhat = 1).
...
rbind(factorised = nec(zib_f),
      joint      = nec(zib_j))
#>                 Q50     Q2.5    Q97.5
#> factorised 1.691950 1.409638 1.919234
#> joint      1.694596 1.402429 1.919369
```
