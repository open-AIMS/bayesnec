...
#> bot_Intercept      0.04      0.02     0.01     0.08 1.00     1968     1161
#> top_Intercept      0.83      0.01     0.81     0.84 1.00     4340     3971
#> beta_Intercept     0.75      0.15     0.49     1.03 1.00     1966     1975
#> nec_Intercept      4.42      0.03     4.34     4.47 1.00     2362     3024
#> 
...
<img src="vignette-fig-exmp1-binom-1.png" title="plot of chunk exmp1-binom" alt="plot of chunk exmp1-binom" width="60%" />
...
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>   19.69   52.27   69.95   66.97   80.45  164.85
```
...
#> Population-Level Effects: 
#>                Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> bot_Intercept      0.08      0.06     0.00     0.20 1.00     2540     2543
#> top_Intercept      0.84      0.03     0.78     0.89 1.00     3700     3316
#> beta_Intercept     0.42      0.53    -0.36     1.89 1.00     1356     1493
#> nec_Intercept      4.25      0.26     3.59     4.54 1.00     1392     2247
#> 
#> Family Specific Parameters: 
#>     Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> phi     5.47      1.28     3.40     8.34 1.00     3725     4291
#> 
#> Draws were sampled using sampling(NUTS). For each parameter, Bulk_ESS
#> and Tail_ESS are effective sample size measures, and Rhat is the potential
#> scale reduction factor on split chains (at convergence, Rhat = 1).
...
<img src="vignette-fig-exmp1-beta-1.png" title="plot of chunk exmp1-beta" alt="plot of chunk exmp1-beta" width="60%" />
...
<img src="vignette-fig-exmp1-poisson-1.png" title="plot of chunk exmp1-poisson" alt="plot of chunk exmp1-poisson" width="60%" />

```r
exp_3$dispersion
#>   Estimate       Q2.5      Q97.5 
#>  2.0896016  0.2036315 57.4802695
```
...
<img src="vignette-fig-exmp1-negbinbase-1.png" title="plot of chunk exmp1-negbinbase" alt="plot of chunk exmp1-negbinbase" width="60%" />
...
<img src="vignette-fig-exmp1-gammabase-1.png" title="plot of chunk exmp1-gammabase" alt="plot of chunk exmp1-gammabase" width="60%" />
...
#> Population-Level Effects: 
#>                Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> bot_Intercept      0.98      0.05     0.88     1.06 1.00     3963     4101
#> top_Intercept      2.44      0.01     2.41     2.46 1.00     6577     5005
#> beta_Intercept     0.64      0.10     0.45     0.83 1.00     3478     3731
#> nec_Intercept      1.50      0.02     1.46     1.53 1.00     4355     4643
#> 
#> Family Specific Parameters: 
#>       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> shape   518.20     74.62   384.81   677.02 1.00     6174     5327
#> 
#> Draws were sampled using sampling(NUTS). For each parameter, Bulk_ESS
#> and Tail_ESS are effective sample size measures, and Rhat is the potential
#> scale reduction factor on split chains (at convergence, Rhat = 1).
