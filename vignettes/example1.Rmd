...
#> bot      0.05      0.02     0.02     0.08 1.00     3054     2893
#> top      0.83      0.01     0.81     0.84 1.00     4781     4677
#> beta     0.81      0.13     0.56     1.08 1.00     2715     3327
#> nec      4.43      0.03     4.36     4.48 1.00     2989     4133
#> 
...
#> Error in bnec(suc | trials(tot) ~ crf(log(raw_x), model = "nec4param"), : object 'beta_binomial2' not found
```
...
#> Error in autoplot(exp_1b, xform = exp): object 'exp_1b' not found
```


```r
exp_1b$dispersion
#> Error in eval(expr, envir, enclos): object 'exp_1b' not found
```
...
#> Error in summary(exp(exp_1b$nec_posterior)): object 'exp_1b' not found
```
...
#> Error in ecx(exp_1b, xform = exp): object 'exp_1b' not found
```
...
```r
summary(exp_1b)
#> Error in summary(exp_1b): object 'exp_1b' not found
```
...
#>  $ y: int  71 95 84 104 56 79 112 72 104 95 ...
summary(count_data$y)
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>    1.00   67.00   83.00   78.56   95.00  127.00
...
exp_3$dispersion
#>    Estimate        Q2.5       Q97.5 
#>   5.1712862   0.8291044 164.3957149
```
...
#> Population-Level Effects: 
#>      Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> bot      0.98      0.05     0.88     1.06 1.00     3691     4225
#> top      2.44      0.01     2.41     2.46 1.00     7374     5577
#> beta     0.65      0.10     0.46     0.84 1.00     3278     3893
#> nec      1.50      0.02     1.46     1.53 1.00     4439     4726
#> 
#> Family Specific Parameters: 
#>       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> shape   515.62     74.70   382.09   681.22 1.00     5983     4591
#> 
#> Draws were sampled using sampling(NUTS). For each parameter, Bulk_ESS
#> and Tail_ESS are effective sample size measures, and Rhat is the potential
#> scale reduction factor on split chains (at convergence, Rhat = 1).
