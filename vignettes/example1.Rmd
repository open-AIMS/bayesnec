...
#> bot      0.05      0.02     0.02     0.08 1.00     3102     3091
#> top      0.83      0.01     0.81     0.84 1.00     4568     4757
#> beta     0.81      0.13     0.56     1.08 1.00     2789     3419
#> nec      4.43      0.03     4.36     4.48 1.00     3002     3852
#> 
...
#> Error in validate_family(family): You have specified family as custom, which is not currently implemented. bnec only allows: gaussian, Gamma, poisson, negbinomial, bernoulli, binomial, beta_binomial, Beta.
```
...
#>  $ y: int  98 86 79 99 93 103 96 104 74 119 ...
summary(count_data$y)
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>    9.00   65.75   83.00   78.86   93.25  131.00
...
exp_3$dispersion
#>    Estimate        Q2.5       Q97.5 
#>  0.45157481  0.02611295 19.28381731
```
...
#> Population-Level Effects: 
#>      Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> bot      0.98      0.05     0.88     1.07 1.00     3512     3994
#> top      2.44      0.01     2.41     2.46 1.00     6222     5092
#> beta     0.65      0.10     0.46     0.85 1.00     2995     4037
#> nec      1.50      0.02     1.46     1.54 1.00     3710     4801
#> 
#> Family Specific Parameters: 
#>       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> shape   516.62     73.27   383.86   675.93 1.00     6104     4973
#> 
#> Draws were sampled using sample(hmc). For each parameter, Bulk_ESS
#> and Tail_ESS are effective sample size measures, and Rhat is the potential
#> scale reduction factor on split chains (at convergence, Rhat = 1).
