...
#> bot      0.05      0.02     0.02     0.08 1.00     2927     2889
#> top      0.83      0.01     0.81     0.84 1.00     4886     4242
#> beta     0.81      0.13     0.57     1.08 1.00     2598     3148
#> nec      4.43      0.03     4.36     4.48 1.00     2952     3911
#> 
...
<img src="vignette-fig-exmp1-binom-1.png" alt="plot of chunk exmp1-binom" width="60%" style="display: block; margin: auto;" />
...
<img src="vignette-fig-exmp1-bbinom-1.png" alt="plot of chunk exmp1-bbinom" width="60%" style="display: block; margin: auto;" />
...
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>   14.10   64.88   79.01   76.10   88.34  199.24
```
...
#> Population-Level Effects: 
#>      Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> bot      0.13      0.06     0.03     0.24 1.00     1406     1603
#> top      0.84      0.03     0.77     0.88 1.00     1673     1715
#> beta     0.85      0.71    -0.18     3.68 1.01      594      257
#> nec      4.37      0.20     3.67     4.62 1.01      661      268
#> 
#> Family Specific Parameters: 
#>     Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> phi     5.33      1.28     3.24     8.31 1.00     1860     3193
#> 
#> Draws were sampled using sampling(NUTS). For each parameter, Bulk_ESS
#> and Tail_ESS are effective sample size measures, and Rhat is the potential
#> scale reduction factor on split chains (at convergence, Rhat = 1).
...
<img src="vignette-fig-exmp1-beta-1.png" alt="plot of chunk exmp1-beta" width="60%" style="display: block; margin: auto;" />
...
#>  $ y: int  111 120 92 105 75 82 98 83 84 94 ...
summary(count_data$y)
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>   11.00   67.00   83.50   80.13   95.75  120.00
...
<img src="vignette-fig-exmp1-poisson-1.png" alt="plot of chunk exmp1-poisson" width="60%" style="display: block; margin: auto;" />

```r
exp_3$dispersion
#>     Estimate         Q2.5        Q97.5 
#>  0.431762747  0.001623024 21.137608229
```
...
<img src="vignette-fig-exmp1-negbinbase-1.png" alt="plot of chunk exmp1-negbinbase" width="60%" style="display: block; margin: auto;" />
...
<img src="vignette-fig-exmp1-gammabase-1.png" alt="plot of chunk exmp1-gammabase" width="60%" style="display: block; margin: auto;" />
...
#> Population-Level Effects: 
#>      Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> bot      0.98      0.05     0.88     1.07 1.00     4246     4626
#> top      2.44      0.01     2.41     2.46 1.00     6687     5291
#> beta     0.65      0.10     0.46     0.84 1.00     3587     4338
#> nec      1.50      0.02     1.46     1.53 1.00     4224     5183
#> 
#> Family Specific Parameters: 
#>       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> shape   516.57     74.96   381.07   671.52 1.00     6091     4974
#> 
#> Draws were sampled using sampling(NUTS). For each parameter, Bulk_ESS
#> and Tail_ESS are effective sample size measures, and Rhat is the potential
#> scale reduction factor on split chains (at convergence, Rhat = 1).
