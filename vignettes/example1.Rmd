...
#> top_Intercept       1.69      0.05     1.59     1.80 1.00     1823     1954
#> slope_Intercept     0.66      0.04     0.58     0.73 1.00     1720     1496
#> nec_Intercept       3.72      0.06     3.61     3.83 1.00     1624     1489
#> 
...
#> Population-Level Effects: 
#>                 Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> top_Intercept       1.81      0.24     1.37     2.31 1.00     1800     1806
#> slope_Intercept     0.45      0.17     0.06     0.76 1.00     1922     1819
#> nec_Intercept       3.46      0.30     2.77     4.02 1.00     1650     1929
#> 
#> Family Specific Parameters: 
#>     Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> phi     5.83      1.35     3.47     8.99 1.00     2178     1905
#> 
#> Samples were drawn using sampling(NUTS). For each parameter, Bulk_ESS
#> and Tail_ESS are effective sample size measures, and Rhat is the potential
#> scale reduction factor on split chains (at convergence, Rhat = 1).
...
#>  $ y: int  86 88 64 83 91 97 74 77 69 90 ...
range(count_data$x)
...
#> Population-Level Effects: 
#>                 Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> top_Intercept       0.89      0.01     0.88     0.91 1.00     3035     2882
#> slope_Intercept    -0.59      0.04    -0.68    -0.51 1.00     2314     2460
#> nec_Intercept       1.31      0.04     1.24     1.38 1.00     2293     2908
#> 
#> Family Specific Parameters: 
#>       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> shape   249.20     35.65   185.25   326.39 1.00     3462     2733
#> 
#> Samples were drawn using sampling(NUTS). For each parameter, Bulk_ESS
#> and Tail_ESS are effective sample size measures, and Rhat is the potential
#> scale reduction factor on split chains (at convergence, Rhat = 1).
