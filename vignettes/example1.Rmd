...
ggplot(data = binom_data, mapping = aes(x = raw_x)) +
  geom_histogram(colour = "white", fill = "grey60") +
  theme_bw() +
  labs(x = "Predictor")
```

<img src="vignette-fig-exmp1-hist-1.png" title="plot of chunk exmp1-hist" alt="plot of chunk exmp1-hist" width="100%" />
...
<img src="vignette-fig-exmp1-brms-1.png" title="plot of chunk exmp1-brms" alt="plot of chunk exmp1-brms" width="100%" />
...
<img src="vignette-fig-exmp1-brmspairs-1.png" title="plot of chunk exmp1-brmspairs" alt="plot of chunk exmp1-brmspairs" width="100%" />
...
#> bot_Intercept      0.04      0.02     0.01     0.08 1.00     2684     2681
#> top_Intercept      0.83      0.01     0.81     0.84 1.00     3797     3975
#> beta_Intercept     0.75      0.14     0.50     1.04 1.00     2435     3222
#> nec_Intercept      4.42      0.03     4.35     4.47 1.00     2834     3716
#> 
...
```r
plot(exp_1, xform = exp)
```

<img src="vignette-fig-exmp1-base-1.png" title="plot of chunk exmp1-base" alt="plot of chunk exmp1-base" width="100%" />
...
<img src="vignette-fig-exmp1-ggplot-1.png" title="plot of chunk exmp1-ggplot" alt="plot of chunk exmp1-ggplot" width="100%" />
...
<img src="vignette-fig-exmp1-bbinom-1.png" title="plot of chunk exmp1-bbinom" alt="plot of chunk exmp1-bbinom" width="100%" />
...
Now that we have a better fit to these data, we can interpret the results. The estimated *NEC* value can be obtained directly from the fitted model object, using `exp_1b$nec`, or we can plot the posterior distribution of the *NEC* values. As explained above, we need to transform *NEC* back to the data scale.
 

```r
exp(exp_1b$nec)
#> Estimate     Q2.5    Q97.5 
#> 70.62425 36.04150 93.72276
data.frame(NEC = exp(exp_1b$nec_posterior)) %>%
  qplot(data = ., geom = "blank") +
    geom_histogram(mapping = aes(x = NEC, y = ..density..), colour = "white",
                   fill = "grey60") +
    geom_line(mapping = aes(x = NEC, y = ..density..), stat = "density") +
    theme_bw() +
    ggtitle("Posterior distribution of NEC")
```

<img src="vignette-fig-exmp1-nechist-1.png" title="plot of chunk exmp1-nechist" alt="plot of chunk exmp1-nechist" width="100%" />
...
<img src="vignette-fig-exmp1-betabrms-1.png" title="plot of chunk exmp1-betabrms" alt="plot of chunk exmp1-betabrms" width="100%" />
...
<img src="vignette-fig-exmp1-betabase-1.png" title="plot of chunk exmp1-betabase" alt="plot of chunk exmp1-betabase" width="100%" />
...
count_data %>%
  tidyr::pivot_longer(cols = c(x, y), names_to = "variable") %>%
  dplyr::mutate(variable = recode(variable, "x" = "Predictor",
                                  "y" = "Total counts")) %>%
...
<img src="vignette-fig-exmp1-poissonhist-1.png" title="plot of chunk exmp1-poissonhist" alt="plot of chunk exmp1-poissonhist" width="100%" />
...
<img src="vignette-fig-exmp1-poissonbrms-1.png" title="plot of chunk exmp1-poissonbrms" alt="plot of chunk exmp1-poissonbrms" width="100%" />
...
<img src="vignette-fig-exmp1-poissonbase-1.png" title="plot of chunk exmp1-poissonbase" alt="plot of chunk exmp1-poissonbase" width="100%" />
...
The chains look OK. However, our plot of the fit is not very convincing. The model uncertainty is very narrow, and this does not seem to be a particularly good model for these data. Note that the dispersion estimate is much greater than one, indicating serious overdispersion. In this case we can try to refit the model but instead deliberately specifying the Negative Binomial distribution for via the `family` argument.
...
<img src="vignette-fig-exmp1-negbinbrms-1.png" title="plot of chunk exmp1-negbinbrms" alt="plot of chunk exmp1-negbinbrms" width="100%" />
...
<img src="vignette-fig-exmp1-negbinbase-1.png" title="plot of chunk exmp1-negbinbase" alt="plot of chunk exmp1-negbinbase" width="100%" />
...
<img src="vignette-fig-exmp1-gammabrms-1.png" title="plot of chunk exmp1-gammabrms" alt="plot of chunk exmp1-gammabrms" width="100%" />
...
<img src="vignette-fig-exmp1-gammabase-1.png" title="plot of chunk exmp1-gammabase" alt="plot of chunk exmp1-gammabase" width="100%" />
