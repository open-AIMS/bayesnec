...
```r
summary(exp_1)
#> Error in summary(exp_1): object 'exp_1' not found
```
...
#> Error in autoplot(exp_1, xform = exp): object 'exp_1' not found
```
...
```r
exp_1$dispersion
#> Error in eval(expr, envir, enclos): object 'exp_1' not found
```
...
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>   19.29   65.04   78.25   75.56   87.30  196.32
```
...
#> bot      0.13      0.05     0.03     0.23 1.00     2426     2639
#> top      0.84      0.03     0.78     0.88 1.00     2270     2967
#> beta     0.82      0.65    -0.18     3.04 1.01      493      164
#> nec      4.36      0.20     3.67     4.58 1.00      535      174
#> 
#> Family Specific Parameters: 
#>     Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> phi     5.34      1.29     3.24     8.30 1.00     2104     3023
#> 
...
#>  $ y: int  96 97 103 75 86 77 68 78 94 89 ...
summary(count_data$y)
#>    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#>   14.00   63.00   81.00   75.49   94.00  126.00
...
exp_3$dispersion
#>    Estimate        Q2.5       Q97.5 
#>  1.23649458  0.06900952 21.87790948
```
...
#> Population-Level Effects: 
#>      Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> bot      0.98      0.05     0.88     1.07 1.00     3789     5044
#> top      2.44      0.01     2.41     2.46 1.00     6505     5346
#> beta     0.65      0.10     0.47     0.85 1.00     3179     4187
#> nec      1.50      0.02     1.46     1.54 1.00     3869     4693
#> 
#> Family Specific Parameters: 
#>       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> shape   517.36     73.71   384.59   676.58 1.00     6540     4876
#> 
#> Draws were sampled using sampling(NUTS). For each parameter, Bulk_ESS
#> and Tail_ESS are effective sample size measures, and Rhat is the potential
#> scale reduction factor on split chains (at convergence, Rhat = 1).
