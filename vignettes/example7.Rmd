...
<!-- NUMBERS IN THIS SECTION ARE GENERATED, NOT TYPED.
     Source: negative-sgr/analysis/phase10_vignette_numbers.R, whose output is
     analysis/phase10_vignette_numbers.txt. Regenerate and update this section
     after any change to the Phase 10 sweep. Figures below are at n = 200 per
     cell (3 cells x 200 x 5 arms, 27,600 model fits, 0 failures, 0 exclusions).
...
been covered by something else. If you re-run this with
`loo_controls = list(weights = list(method = "stacking"))` the weights will move
and should not be compared with these.
