...
the zero boundary deliberately are biased low by 5 to 10 per cent, in the
...
**none** of the 500 simulated datasets, and B3 and E likewise miss almost every
ErC10 interval (0.000 and 0.126). F is not far behind at 0.116 on ErC50. The
...
under B3, E and F the constrained curve visibly cannot follow the data, so it
compensates by flattening its descent and pushing `nec` to the right, and the
toxicity estimates follow. A more flexible equation might follow the same
