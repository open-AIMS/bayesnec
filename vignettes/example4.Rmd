...
#> Error in head(post_comp_fitted$posterior_data): object 'post_comp_fitted' not found
head(post_comp_fitted$diff_data)
#> Error in head(post_comp_fitted$diff_data): object 'post_comp_fitted' not found
```
...
ggplot(data = post_comp_fitted$posterior_data) +
  ...
  theme_classic()
#> Error in ggplot(data = post_comp_fitted$posterior_data): object 'post_comp_fitted' not found
```
...
ggplot(data = post_comp_fitted$diff_data) +
  ...
  theme_classic()
#> Error in ggplot(data = post_comp_fitted$diff_data): object 'post_comp_fitted' not found
```
...
ggplot(data = post_comp_fitted$prob_diff) +
  ...
  theme_classic()
#> Error in ggplot(data = post_comp_fitted$prob_diff): object 'post_comp_fitted' not found
```
