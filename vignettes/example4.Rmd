...
## Comparing posterior estimate values
...
<img src="vignette-fig-exmp4-posterior-1.png" alt="plot of chunk exmp4-posterior" width="60%" style="display: block; margin: auto;" />
...
<img src="vignette-fig-exmp4-differences-1.png" alt="plot of chunk exmp4-differences" width="60%" style="display: block; margin: auto;" />
...
We can formally test the probability that the estimate estimate for one model set is greater than the other using posterior differencing. This is contained in the compare posterior output as `prob_diff`. Here you can see there is 59% chance that **all** is greater than **ecx**. There is only a 19% chance that **ecx** is greater than **nec**, and a 81% chance that the **nec** is greater than **ecx**.
...
#> 1   all 0.09090909 1.019020 0.9666849 1.082869
#> 2   all 0.29313544 1.018810 0.9666849 1.080923
#> 3   all 0.49536178 1.018470 0.9666849 1.079075
#> 4   all 0.69758813 1.018290 0.9666849 1.076531
#> 5   all 0.89981447 1.017999 0.9665524 1.074180
#> 6   all 1.10204082 1.017360 0.9665524 1.072261
head(post_comp_fitted$diff_data)
#>   comparison diff.Estimate   diff.Q2.5 diff.Q97.5          x
#> 1    all-ecx  -0.005951000 -0.08953365 0.07799862 0.09090909
#> 2    all-ecx  -0.005830145 -0.08748589 0.07722827 0.29313544
#> 3    all-ecx  -0.005627377 -0.08594400 0.07599522 0.49536178
#> 4    all-ecx  -0.005598364 -0.08329105 0.07519030 0.69758813
#> 5    all-ecx  -0.005340098 -0.08139395 0.07415155 0.89981447
#> 6    all-ecx  -0.004934536 -0.07936624 0.07295507 1.10204082
```
...
<img src="vignette-fig-exmp4-fitteddiff-1.png" alt="plot of chunk exmp4-fitteddiff" width="60%" style="display: block; margin: auto;" />
...
<img src="vignette-fig-exmp4-probplot-1.png" alt="plot of chunk exmp4-probplot" width="60%" style="display: block; margin: auto;" />
