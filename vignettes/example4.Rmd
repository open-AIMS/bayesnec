...
<img src="vignette-fig-exmp4-posterior-1.png" title="plot of chunk exmp4-posterior" alt="plot of chunk exmp4-posterior" width="60%" />
...
<img src="vignette-fig-exmp4-differences-1.png" title="plot of chunk exmp4-differences" alt="plot of chunk exmp4-differences" width="60%" />
...
#> 1   all 0.0000000 0.9550915 0.9063234 1.005405
#> 2   all 0.2040816 0.9550607 0.9063234 1.005405
#> 3   all 0.4081633 0.9550418 0.9063234 1.005367
#> 4   all 0.6122449 0.9549862 0.9063234 1.005360
#> 5   all 0.8163265 0.9549567 0.9063234 1.005347
#> 6   all 1.0204082 0.9546666 0.9063234 1.005326
head(post_comp_fitted$diff_data)
#>   comparison diff.Estimate   diff.Q2.5 diff.Q97.5         x
#> 1    all-ecx  -0.003594019 -0.07226712 0.06619291 0.0000000
#> 2    all-ecx  -0.003579761 -0.07212127 0.06618201 0.2040816
#> 3    all-ecx  -0.003641650 -0.07199838 0.06616431 0.4081633
#> 4    all-ecx  -0.003641650 -0.07197235 0.06613373 0.6122449
#> 5    all-ecx  -0.003476075 -0.07167768 0.06608714 0.8163265
#> 6    all-ecx  -0.003430933 -0.07123528 0.06599472 1.0204082
```
...
<img src="vignette-fig-exmp4-fitted-1.png" title="plot of chunk exmp4-fitted" alt="plot of chunk exmp4-fitted" width="60%" />
...
<img src="vignette-fig-exmp4-fitteddiff-1.png" title="plot of chunk exmp4-fitteddiff" alt="plot of chunk exmp4-fitteddiff" width="60%" />
...
<img src="vignette-fig-exmp4-probplot-1.png" title="plot of chunk exmp4-probplot" alt="plot of chunk exmp4-probplot" width="60%" />
