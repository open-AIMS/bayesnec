...
The [Installation and setup](https://open-aims.github.io/bayesnec/articles/example5.html)
vignette works through this in detail: the two `brms` back ends, the `cmdstanr`
installation the vignettes are built with, and the failures most often met on
Windows.
