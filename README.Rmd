...
page](https://open-aims.github.io/bayesnec) and the [vignette](https://open-aims.github.io/bayesnec/articles/example.html). Help files for the individual functions can be found on the [reference page](https://open-aims.github.io/bayesnec/reference/index.html).
