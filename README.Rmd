...
estimating both ECX values, but more particularly NEC. Please see `?bnec` for a
...
compiler is required. The program Rtools
...
instructions on how to get the compilers running, see the prerequisites section
on https://github.com/stan-dev/rstan/wiki/RStan-Getting-Started.
...
GPL-2 License ([GPL-2](https://opensource.org/licenses/GPL-2.0)).
