...
```
```{r echo=FALSE, out.width='100%', fig.cap="\\label{fig:checkpriorsplot}A comparison of the prior and posterior parameter probability densities for the nec4param model fit to the example nec_data."}
