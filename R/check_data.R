...
check_data <- function(data, family, model) {
  ...
  # diagnostic does not depend on whether a nudge would have fired. beta_ub is
  # absent from both lists because it rejects zeros outright just below, where
  # the message can be specific to that family.
