...
#' truncated to the tested range; #393 removed that truncation, which rescales
#' each of them by the mass above the highest dose and leaves them inside the
#' series.
#'
...
#' entry truncated to the tested range, which is what it carried when they were
