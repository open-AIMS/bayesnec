...
cf <- compare_fitted(list(ecx4param = ecx4param, nec4param = nec4param), precision = 10)
...
test_that("output is a list of appropriately name elements", {
  ...
  expect_equal(names(cf), c("posterior_list", "posterior_data", "diff_list", "diff_data", "prob_diff"))
})
